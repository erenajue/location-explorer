...
import lombok.*;
import lu.hitec.dispng.locationexplorer.basis.Traceable;
import lu.hitec.dispng.locationexplorer.exception.InsufficientRequiredPointsException;
import lu.hitec.dispng.locationexplorer.utils.GeometryTools;
...
public class GPSTrack implements Traceable {
    ...
    // TODO: Add here the user being tracked (all point users)
    ...
    public String asGpxString() throws IOException {
        ...
        return new String(gpxBaos.toByteArray());
    }
